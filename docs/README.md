...
| 4 | [04_temporary_system_contract.md](04_temporary_system_contract.md) | Frozen temporary vocabulary, record shapes, profile, Layer 1 normalization, and Layer 2 evaluation contract; not a future public API. | Temporary |
